...
2.  create tbl_branch_clean, in this steps will be formed a stream, the data in 
    the payload in tbl_branch_raw will be taken, and it will be split into columns 
    and the results of this stream will also be stored in the kafka topic 'tbl_branch_clean'
3.  create tbl_branch_table, in this step we make table from topic tbl_branch_clean, 
