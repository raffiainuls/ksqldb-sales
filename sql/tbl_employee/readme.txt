...
1.  create tbl_employee_raw, where 
...
2.  create tbl_employee_clean, in this steps will be formed a stream, the data in 
    the payload in tbl_branch_raw will be taken, and it will be split into columns 
    and the results of this stream will also be stored in the kafka topic 'tbl_employee_clean'
3.  create tbl_employee_table, in this step we make table from topic tbl_employee_clean, 
